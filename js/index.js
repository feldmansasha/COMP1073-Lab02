/* Declare and initialize global variables
        ...
        function changeRgb(channel, value){
            ...
            // function returns array with RGB number of the colors (from 0 to 255)
            return rgb;
        }

        function writeCSS(newArray){
            var newColor='rgb(';
            ...
            newColor+=")";
            // function returns string, that can be used as background color styling.
            // for example: rgb(123,22,45) 
            return newColor;
        }